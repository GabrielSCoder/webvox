...
const contentStyle = "p-[20px] px-10 xl:px-36 fixed left-1/2 top-1/2 h-[80dvh] md:h-[70dvh] xl:h-[60dvh] max-h-[100vh] w-[90dvw] md:w-[400px] lg:w-[600px] -translate-x-1/2 -translate-y-1/2 rounded-2xl bg-black shadow-[var(--shadow-6)] focus:outline-none data-[state=open]:animate-contentShow"
